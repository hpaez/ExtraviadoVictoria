...
public class CtrlIngExtraviado implements ActionListener, KeyListener {
    ...
    public Object creaObjectExtraviado(int opcion) {
        ...
        Extraviado extraviado = new Extraviado(id_, vistaExtraviado.txt_nombre.getText().trim(), vistaExtraviado.txt_apellidos.getText().trim(), vistaExtraviado.combo_cOjos.getSelectedIndex(), vistaExtraviado.combo_cPelo.getSelectedIndex(), vistaExtraviado.combo_cPiel.getSelectedIndex(), Double.parseDouble(vistaExtraviado.txt_altura.getText()), vistaExtraviado.combo_contextura.getSelectedIndex(), Integer.parseInt(vistaExtraviado.txt_peso.getText()), vistaExtraviado.textarea_comentario.getText().trim());
        //**************************************************************
        int id_x = 0;
    ...
    public void realizarIngreso(int opcion, ExtraviadoVO extraviado_vo, Persona persona, PersonaDAO persona_dao, CasoVO caso_vo) {
        PersonaVO persona_vo = new PersonaVO(persona);
